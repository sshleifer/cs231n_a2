...
class TestNB2(unittest.TestCase):
    ...
    def test_lstm_step_backward(self):
        ...
        print('dWx error: ', rel_error_assert(dWx_num, dWx))
        print('dWh error: ', rel_error_assert(dWh_num, dWh, 1e-7))
        print('db error: ', rel_error_assert(db_num, db))
    ...
    def test_lstm_forward(self):
        ...
        print('h error: ', rel_error_assert(expected_h, h, 1e-7))
    ...
    def test_lstm_backward(self):
        ...
        print('dx error: ', rel_error_assert(dx_num, dx))
        print('dh0 error: ', rel_error_assert(dh0_num, dh0, 1e-7))
        print('dWx error: ', rel_error_assert(dWx_num, dWx))
        print('dWh error: ', rel_error_assert(dWh_num, dWh, 1e-6))
        print('db error: ', rel_error_assert(db_num, db, 1e-7))
