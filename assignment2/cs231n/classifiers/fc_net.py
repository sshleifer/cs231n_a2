...
class bFullyConnectedNet(object):
    """
        ...
        for i in range(self.num_layers):
            ...
            # With batch normalization
                ...
                # Intermediate hidden layer
                    ...
                    self.params[W_i] = np.random.randn(hidden_dims[i - 1],
        ...
        for i in range(self.num_layers, 0, -1):
            ...
            if i == self.num_layers:
                ...
                if self.normalization == 'batchnorm':
                    ...
                    dfc_out, grads['gamma' + str(i)], grads['beta' + str(i)] = batchnorm_backward(
                        dbn_out, bn_cache)
                    dout, grads['W' + str(i)], grads['b' + str(i)] = affine_backward(dfc_out,
                                                                                     fc_cache)
                    ...
                    dfc_out, grads['gamma' + str(i)], grads['beta' + str(i)] = layernorm_backward(
                        dln_out, ln_cache)
                    dout, grads['W' + str(i)], grads['b' + str(i)] = affine_backward(dfc_out,
                                                                                     fc_cache)
